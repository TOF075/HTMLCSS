...
if(isset($_GET['id']) AND $_GET['id'] > 0) {
   ...
   echo $su->getProfileRH($getid);
   
	if(isset($_SESSION['id']) AND $_GET['id'] == $_SESSION['id']) {
?>
		<div class="text-center">
			<button class="btn text-white" style="background-color: orange !important" onclick="location.href='editionprofil2.php'" type="button">Editer mon profil</button>
			&nbsp;
